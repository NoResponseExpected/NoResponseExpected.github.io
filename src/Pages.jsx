  ...
  return (
    <div className="hub-content" data-screen-label="Home">
      ...
      <p className="hub-lede">
        This site is a questions bank of A level practice questions. All questions are kindly generated by Claude, so if you spot any errors please make them known at <a href="https://vksl.uk/feedback" target="_blank" rel="noreferrer">VKSL Feedback</a>. Make sure to specify this site as this is a slightly unrelated side project. 
